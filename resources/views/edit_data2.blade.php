            ...
            <div class="row page-bg">
                <div class="p-4 col-md-12">
                    <div class="text-center top-icon">
                        ...
                        <form id="form-login" action="{{ route('artikel.update2' ,$data->id) }}" method="post">
                            @csrf
                            <div>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="kota_asal" type="text"
                                       placeholder="kota asal" value="{{ $data->kota_asal ? $data->kota_asal : 'Tidak Ada Data' }}" autofocus required>
                            </div>
                            ...
                            <div>
                                <input class="mt-3 form-control form-control-lg" name="ipk" type="text"
                                       placeholder="nrp" value="{{ $data->ipk ? $data->ipk : 'Tidak Ada Data' }}" autofocus required>
                            </div>
